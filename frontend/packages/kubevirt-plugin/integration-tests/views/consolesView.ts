...
export const consoleTypeSelectorId = '#pf-v5-c-console__type-selector';
...
export const launchRemoteViewerButton = $('.remote-viewer-pf-v5-launch-vv');
export const launchRemoteDesktopButton = $('.remote-viewer-pf-v5-launch-rdp');
...
export const vncSendKeyButton = $('#pf-v5-c-console__actions-vnc-toggle-id');
export const vncConsole = $('div.pf-v5-c-console__vnc canvas');
