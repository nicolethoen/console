...
export const uploadProgress = element.all(by.css('.pf-v5-c-progress__measure')).first();
...
export const errorUploading = $('.pf-v5-c-empty-state__body');
export const disabled = $('.pf-v5-c-dropdown__menu-item.pf-m-disabled');
export const typeWarnMessage = element(
  by.cssContainingText('.pf-v5-c-alert__title', 'File type extension'),
);
